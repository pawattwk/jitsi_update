 ...
 * @private
 */
const _LEFT_WATERMARK_STYLE = {
    backgroundImage: `url(${interfaceConfig.BRAND_URL})`
    // 'url(https://oneconf-dev3.cloudns.asia/images/inetlogo.png)'
};
