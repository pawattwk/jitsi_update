...
export function submitFeedback(
    ...
    //     );
        ...
        // fetch("https://us-central1-oneconfjitsi.cloudfunctions.net/widgets/save?score="+score+"&message="+message, requestOptions)
        ...
        // var raw = JSON.stringify({"score":score,"message":message, "room":room,});
        // console.log('___',raw);
        var myHeaders = new Headers();
        myHeaders.append("Content-Type", "application/json");
