            ...
            <div class="container"
                    ...
                    <div id = 'enter_room'>
                        ...
                        <div
                            ...
                            {/* <div className ='page-content'>
                                <div className ='page-photoby' style={{position: 'fixed', bottom: '21px',right:'27px'}} >
                                    <img  style={{position: 'fixed', bottom: '23px', color: '#fff',right:'255px'}} src="../images/cr.jpg" />
                                    <a style={{color: '#fff',textDecoration: 'none'}} href="https://www.facebook.com/milkywaypixels" target="_blank"> 
                                        { t('welcomepage.photoBy') }
                                    </a>
                                </div>
                            </div>  */}
                        </div>
                ...
                { showAdditionalContent
                    ...
                    : null }
                        ...
                        <div className ='page-content'>
                            <img style={{position: 'absolute' ,bottom: '3', right: '205px'}} src="../images/cr.jpg" />
                        </div> 
                        <a style={{color: '#fff',textDecoration: 'none',  bottom: '12',right: '13px',position: 'absolute',cursor: 'pointer', zIndex:'0'}}
                            onClick={()=> window.open("https://www.facebook.com/milkywaypixels") }> 
                                { t('welcomepage.photoBy') }
                        </a>  
            </div>
        );
