...
var interfaceConfig = {
    ...
    JITSI_WATERMARK_LINK: '/images/inetlogo.png',
   ...
   /** TOOLBAR_BUTTONS: [
        ...
        'tileview', 'videobackgroundblur', 'download', 'help', 'end-meeting','mute-everyone', 'security'
    ],*/
    ...
    TOOLBAR_BUTTONS: [
        ...
        'tileview', 'download', 'help', 'end-meeting','mute-everyone', 'security'
    ],
